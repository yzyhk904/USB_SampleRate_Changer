...
#
# Try to use this for investigating differences of 179dB_408_99 and "cheapies_44k" after setting from 44.1kHz to 706kHz (16x) or 354kHz (8x) in 32bit depth up-sampling
#

MODDIR=${0%/*/*/*}
su -c "/system/bin/sh ${MODDIR}/extras/change-resampling-quality.sh 179 520 93"
